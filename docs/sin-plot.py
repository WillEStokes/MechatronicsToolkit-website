...
# Label the axes "X" and "Im"
fig.update_layout(xaxis_title='X', yaxis_title='Im',
...
fig.update_layout(annotations=[dict(text="<i>e<sup>ix</sup>", showarrow=False, x=3, y=0.8, xref="x", yref="y",
